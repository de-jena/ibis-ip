 ...
 * @since Jun 19, 2023
 * 
 * This REST Resource is responsible to handle the requests from the Mobile Load Management System,
 * which is intended to prevent overloads in the tram grid and the peripheral components.
 */
@RequireJakartarsWhiteboard
@RequireHttpWhiteboard
@JakartarsResource
@RequireEMFMessageBodyReaderWriter
@Component(immediate=true, name = "MLMSResource", service = MLMSResource.class)
@Path("mlms")
public class MLMSResource {
