...
//
//	@Reference
//	VehicleStatusService deviceStatusService;
//	
...
//		List<OnlineVehicle> onlineDevices = deviceStatusService.getOnlineVehicles();
...
//		List<OnlineDevice> onlineDevices = deviceStatusService.getOnlineVehicles();
//		de.jena.model.ibis.rest.Response response = IbisRestFactory.eINSTANCE.createResponse();
...
//		if(!deviceStatusService.isServiceAvailableOnVehicle("CustomerInformationService", deviceId)) {
...
//		if(!deviceStatusService.isServiceAvailableOnVehicle("GNSSLocationService", deviceId)) {
