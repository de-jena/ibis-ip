...
public interface CustomerInformationServiceConstants {
	...
	public static List<String> getAllGetOperations() {
		return Arrays.asList(OPERATION_GET_ALL_DATA, OPERATION_GET_CURRENT_ANNOUNCEMENT, OPERATION_GET_CURRENT_CONNECTION_INFO,
	...
	public static List<String> getAllSubscriptionOperations() {
		return Arrays.asList(OPERATION_SUBSCRIBE_ALL_DATA, OPERATION_SUBSCRIBE_CURRENT_ANNOUNCEMENT, OPERATION_SUBSCRIBE_CURRENT_CONNECTION_INFO,
	...
	public static List<String> getAllUnsubscriptionOperations() {
		return Arrays.asList(OPERATION_UNSUBSCRIBE_ALL_DATA, OPERATION_UNSUBSCRIBE_CURRENT_ANNOUNCEMENT, OPERATION_UNSUBSCRIBE_CURRENT_CONNECTION_INFO,
